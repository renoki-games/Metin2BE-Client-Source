...
#ifdef HAVE_PSI_SP_INTERFACE
static inline struct PSI_sp_locker * inline_mysql_start_sp(PSI_sp_locker_state * state, PSI_sp_share * sp_share)
{
...
static inline void inline_mysql_drop_sp(uint sp_type,
